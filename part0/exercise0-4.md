...
Note right of browser: Submitting the form sends an <br>HTTP POST request to "/new_note"
    ...
    activate server
Note right of server: Server receives data as body of POST request,<br> server accesses it through req.body.note, <br>creates new note object from it and adds it to array of notes
